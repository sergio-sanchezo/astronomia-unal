...
const SolarSystemMap = () => {
  const [center, setCenter] = useState([4.6371, -74.083254]);
      ...
      <div className={styles.container}>
        <div className={styles.sidebar}>
          ...
          <div className={styles.inputGroup}>
            ...
            <label className={styles.label}>
              Para cambiar el lugar de origen da click en el mapa
            </label>
            <div />
          </div>
            ...
            {({ TileLayer, Circle, Popup, ScaleControl }) => (
              <>
                ...
                {planetData.map((planet, idx) => {
                  ...
                  const orbitalRadiusInMeters =
                    scaleOrbitalDistance(planet.orbitalRadiusAU) / 100; // Convert cm to meters
                ...
                {planetData.map((planet, idx) => {
                  ...
                  if (planet.name === "Luna") {
                    ...
                    planetPosition = getMoonPosition(
                      earthPosition,
                    ...
                    >
                      <Popup>
                        <div>
                          ...
                          Diámetro:{" "}
                          {(
                            scaleDiameterToMeters(planet.diameterScale) * 100
                          ).toFixed(2)}{" "}
                          centímetros
                          <br />
                          Distancia al Sol:{" "}
          ...
          <ul>
            {planetData.map((planet, idx) => (
              <li key={idx}>
                ...
                <br />
                Diámetro:{" "}
                {(scaleDiameterToMeters(planet.diameterScale) * 100).toFixed(
                  2
                )}{" "}
                centímetros
                <br />
                Distancia al Sol:{" "}
                {(
                  scaleOrbitalDistance(planet.orbitalRadiusAU) / 100000
                ).toFixed(2)}{" "}
                km
              </li>
            ))}
